	...
	<div class="join w-full">
		<button
			class="btn join-item flex-1 heading-03 gap-1 py-2 px-6 {petitionByHardPaper
				? ''
				: 'opacity-50'}"
			on:click={() => (petitionByHardPaper = true)}
		>
			แบบกระดาษ
			<svg
			...
			>
				<path
					d="M11.5 3.33838C10.8584 3.33838 10.2311 3.5283 9.69722 3.88422C9.16336 4.24013 8.74678 4.7461 8.5 5.33838C8.25322 4.7461 7.83664 4.24013 7.30278 3.88422C6.76891 3.5283 6.14163 3.33838 5.5 3.33838C4.70435 3.33838 3.94129 3.65445 3.37868 4.21706C2.81607 4.77967 2.5 5.54273 2.5 6.33838C2.5 9.40088 8.5 14.3384 8.5 14.3384C8.5 14.3384 14.5 9.40088 14.5 6.33838C14.5 5.54273 14.1839 4.77967 13.6213 4.21706C13.0587 3.65445 12.2956 3.33838 11.5 3.33838Z"
					fill="black"
				/>
			</svg>
		</button>
		<button
			class="btn join-item flex-1 heading-03 gap-1 py-2 px-6 {petitionByHardPaper
				? 'opacity-50'
				: ''}"
			on:click={() => (petitionByHardPaper = false)}>แบบออนไลน์</button
		>
	</div>
	{#if petitionByHardPaper}
		<p>
			เราอยากให้ลงลายมือชื่อบนกระดาษมากกว่าออนไลน์ เพราะประกาศของกกต.
			เขียนไว้ไม่ชัดเจนว่าลงชื่อทางออนไลน์ได้หรือไม่ได้
			จึงต้องรวบรวมชื่อบนกระดาษให้ได้ 50,000 เป็นอย่างน้อยก่อน
		</p>
		<div class="p-4 bg-base-100 grid gap-3 text-left">
			<h1 class="heading-responsive-01">
				วิธีที่ 1 : เดินทางไปลงชื่อที่จุดตั้งโต๊ะ
			</h1>
			<a
				href="/locations"
		...
		<p>หรือ</p>
		<div class="p-4 bg-base-100 text-left">
			<h1 class="heading-responsive-01 mb-3">
				วิธีที่ 2 : ดาวน์โหลดแบบฟอร์มมากรอก
			</h1>
			...
			<div class="border-t grid gap-2 py-5">
				...
				<div class="grid gap-1">
					...
					<a
						href="https://goo.gl/maps/PM5nXuVFUv5GCUZw7"
						class="link px-6 py-2 text-center text-accent font-bold heading-03"
						>ดูแผนที่</a
					>
				</div>
				<div class="grid gap-1">
					...
					<p class="p-2 font-semibold bg-[#F2F2F2] text-center">
						ตู้ ปณ.79 ปณศ.สามเสนใน เขตพญาไท กรุงเทพฯ ประเทศไทย 10400 โทร.
						0996786031
					</p>
				</div>
			</div>
